...
.logowm img{width:min(660px,86%);opacity:.28;filter:brightness(1.15) saturate(1.25)
 drop-shadow(0 0 12px rgba(167,139,250,.95)) drop-shadow(0 0 30px rgba(139,92,246,.9))
 drop-shadow(0 0 66px rgba(124,58,237,.72)) drop-shadow(0 22px 48px rgba(0,0,0,.5))}
